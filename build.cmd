...
@powershell -NoProfile -ExecutionPolicy unrestricted -Command "$ProgressPreference = 'SilentlyContinue'; $NuGetUrl = 'https://dist.nuget.org/win-x86-commandline/' + $Env:NUGET_VERSION + '/nuget.exe'; Invoke-WebRequest $NuGetUrl -OutFile '%CACHED_NUGET%'"
